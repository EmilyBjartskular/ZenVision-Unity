...
public class AzureSpatialAnchorsScript : MonoBehaviour
{
    ...
    /// </summary>
    protected string SpatialAnchorsAccountId = "c49f2b53-918d-4323-817a-02a445d54c50";

    /// <summary>
    /// Set this string to the Spatial Anchors account key provided in the Spatial Anchors resource.
    /// </summary>
    protected string SpatialAnchorsAccountKey = "AzY54AQI0EbBZC+xZk78epzgrZoWlCTOlkbQxSUdrYY=";

    /// <summary>
    /// Set this string to the Spatial Anchors account domain provided in the Spatial Anchors resource.
    /// </summary>
    protected string SpatialAnchorsAccountDomain = "westeurope.mixedreality.azure.com";
